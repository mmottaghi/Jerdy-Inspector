...
#ifndef FZoomableTreeH
#define FZoomableTreeH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <ToolWin.hpp>
//---------------------------------------------------------------------------
class TZoomableTree : public TFrame
{
__published:	// IDE-managed Components
  ...
  TAction *actZoomIn;
  TAction *actZoomOut;
  TAction *actResetSize;
  TToolBar *Toolbar;
  TToolButton *btnHideButtons;
  TToolButton *btnDelim;
  TToolButton *btnZoomIn;
  TToolButton *btnZoomOut;
  TToolButton *btnZoomReset;
  TTreeView *Tree;
  void __fastcall actZoomInExecute(TObject *Sender);
  void __fastcall actZoomOutExecute(TObject *Sender);
  void __fastcall actResetSizeExecute(TObject *Sender);
  void __fastcall btnHideButtonsClick(TObject *Sender);
private:	// User declarations
public:		// User declarations
  __fastcall TZoomableTree(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TZoomableTree *ZoomableTree;
//---------------------------------------------------------------------------
#endif
